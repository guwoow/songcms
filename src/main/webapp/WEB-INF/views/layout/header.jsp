...
<header class="main-header">
	<a href="/" class="logo"> <span class="logo-mini"><b>S</b>CMS</span> <span class="logo-lg"><b>Song</b>CMS</span></a>
	<nav class="navbar navbar-static-top" role="navigation">
		<a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button"> <span class="sr-only">切换导航</span></a>
					...
					<ul class="dropdown-menu">
						...
						<li>
							<ul class="menu">
								<li><a href="#">
										<div class="pull-left">
											<img src="<%=request.getContextPath()%>/resources/AdminLTE/2.4.3/img/user4-128x128.jpg" class="img-circle" alt="User Image">
										</div>
										<h4>
